...
src_prepare() {
	...
	epatch "${FILESDIR}/0001-Add-Argent-customizations.patch"
	epatch "${FILESDIR}/0002-Drop-Fedora-workflows-add-Argent-one.patch"
	epatch "${FILESDIR}/0003-Make-report_Bugzilla-use-Argent-s-bugzilla-URL.patch"
